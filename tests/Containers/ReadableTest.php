...
use JaegerApp\Validate\Rules\Rcf\Containers\Readable;
...
class ReadableTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('rcf_container_readable', 'connection_field', $creds)->val(array(
    ...
    {
        $val = new Validate();
        $val->rule('rcf_container_readable', 'connection_field', $this->getRcfCreds())
            ->val(array(
